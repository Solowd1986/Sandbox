        ...
        return (
            <ul className={styles.header__nav_list}>
                <li className={styles.header__nav_item}>
                    ...
                    <ul className={styles.header__inner_list}>
                ...
                <li className={styles.header__nav_item}>
                    <NavLink to={"/category/other/accessoires"} className={styles.header__nav_link}>Аксессуары
                        <span className={styles.header__nav_link__arrow}/>
                    </NavLink>
                    <ul className={styles.header__inner_list}>
                        <li className={styles.header__inner_item}>
                            <NavLink to={"/category/other/accessoires"} className={styles.header__inner_link}>
                                <svg viewBox="0 0 1000 1000" width={32} height={32}>
                                    <path
                ...
                {/*Gadgerts*/}
                <li className={styles.header__nav_item}>
                    <NavLink to={"/category/other/gadgets"} className={styles.header__nav_link}>Гаджеты
                        <span className={styles.header__nav_link__arrow}/>
                    </NavLink>
                    <ul className={styles.header__inner_list}>
                        <li className={styles.header__inner_item}>
                            <NavLink to={"/category/other/gadgets"} className={styles.header__inner_link}>
                                <svg viewBox="0 0 1000 1000" width={32} height={32}>
                                    <path
