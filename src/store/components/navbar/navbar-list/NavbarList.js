        ...
        return (
            <ul className="header__nav-list">
                <li className="header__nav-item">
                    <a className="header__nav-link " href="">Смартфоны
                        <span className="header__nav-link--arrow"/>
                    </a>
                    <ul className="header__inner-list">
                        <li className="header__inner-item">
                            <a className="header__inner-link" href="/categories.html">
                ...
                <li className="header__nav-item">
                    <a className="header__nav-link" href="/other-categories.html">Аксессуары
                        <span className="header__nav-link--arrow"/>
                    </a>
                    <ul className="header__inner-list">
                        <li className="header__inner-item">
                ...
                <li className="header__nav-item">
                    <a className="header__nav-link" href="">Гаджеты
                        <span className="header__nav-link--arrow"/>
                    </a>
                    <ul className="header__inner-list">
