    ...
    render() {
        return (
            <div className="header__order-wrapper">
                <a className="header__order-phone" href="tel:8800888888">
                    <svg className="header__order-phone-icon" viewBox="0 0 30 30" width={30} height={30}>
                        <path
                ...
                <a className="header__cart header__cart-link" href="basket.html">
                    <svg className="user-cart" width={35} height={35} viewBox="0 0 26 26">
                        <path
                    ...
                    <span className="basket-counter-bg">
                        <span className="basket-counter">4</span>
                    </span>
                </a>
            </div>
        )
